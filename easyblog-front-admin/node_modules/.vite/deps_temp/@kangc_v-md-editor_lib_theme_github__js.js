    ...
    !function(e, t) {
      ...
      return function(e) {
        ...
        t.lib = {}, t.lib.mdurl = r(8), t.lib.ucmicro = r(26), t.assign = function(e2) {
          ...
          return e2 = e2.trim().replace(/\s+/g, " "), "\u1E7E" === "\u1E9E".toLowerCase() && (e2 = e2.replace(/ẞ/g, "\xDF")), e2.toLowerCase().toUpperCase();
        };
      }, function(e, t, r) {
        "use strict";
        function n() {
        ...
        function l(e2) {
          var t2, r2, s2 = 0;
          for (t2 = e2.length - 1; t2 >= 0; t2--)
            "text" !== (r2 = e2[t2]).type || s2 || n.test(r2.content) && (r2.content = r2.content.replace(/\+-/g, "\xB1").replace(/\.{2,}/g, "\u2026").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/gm, "$1\u2014").replace(/(^|\s)--(?=\s|$)/gm, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/gm, "$1\u2013")), "link_open" === r2.type && "auto" === r2.info && s2--, "link_close" === r2.type && "auto" === r2.info && s2++;
        }
        e.exports = function(e2) {
          var t2;
